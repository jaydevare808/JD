...
public class MainActivity extends Activity {
    ...
    private void buildUi(){
        ...
        editorRow.addView(lineNumbers,new LinearLayout.LayoutParams(dp(42),0,1));
        editor=new EditText(this); editor.setTextColor(Color.rgb(234,240,246)); editor.setHintTextColor(Color.rgb(90,105,125)); editor.setTextSize(14); editor.setTypeface(Typeface.MONOSPACE); editor.setGravity(Gravity.TOP|Gravity.START); editor.setPadding(dp(8),dp(10),dp(8),dp(20)); editor.setBackgroundColor(Color.rgb(18,24,33)); editor.setSingleLine(false); editor.setHorizontallyScrolling(true); editor.setOverScrollMode(View.OVER_SCROLL_ALWAYS);
        editorRow.addView(editor,new LinearLayout.LayoutParams(0,0,1)); root.addView(editorRow,new LinearLayout.LayoutParams(-1,0,1.0f));
